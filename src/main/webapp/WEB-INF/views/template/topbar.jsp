		...
		<c:if test="${not empty member}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${member.member_id}</span>
			...
			<c:if test="${empty member}">
						<li class="nav-item">
							<a class="nav-link text-body" href="/member/join">JOIN</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-body" href="/member/login">LOGIN</a>
						</li>
			</c:if>
